...
;
	...
	jsr     pushax
	lda     #$00
L089A:	jsr     _flipSprite
;
; if ( ( frameCount & 0x0F ) == 0x0F ) {
;
L089C:	lda     _frameCount
	and     #$0F
	cmp     #$0F
	bne     L05DE
;
...
;
	...
	jsr     pusha
	lda     _bottomSide
L08A7:	jsr     _getCollisionIndex
	sta     _testCorner
	stx     _testCorner+1
;
; return collisionMap[testCorner];
;
L0634:	lda     #<(_collisionMap)
	sta     ptr1
	lda     #>(_collisionMap)
	clc
	adc     _testCorner+1
...
;
	...
	jsr     pusha
	lda     _bottomSide
L08AC:	jsr     _getCollisionIndex
	sta     _testCorner
	stx     _testCorner+1
;
; return collisionMap[testCorner];
;
L0663:	lda     #<(_collisionMap)
	sta     ptr1
	lda     #>(_collisionMap)
	clc
	adc     _testCorner+1
...
;
L0889:	lda     #<(_playerSpriteData)
	ldx     #>(_playerSpriteData)
	jsr     pushax
	lda     #$03
L08F9:	jsr     _setSpritePalette
;
; ++frameCount;
;
	inc     _frameCount
