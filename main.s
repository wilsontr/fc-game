...
; ++enemyIndex;
;
L0793:	inc     _enemyIndex
;
; while ( !enemyColliding && ( enemyIndex < numEnemies ) ) {
;
L05BC:	lda     _enemyColliding
	bne     L0794
	tax
	lda     _enemyIndex
	cmp     _numEnemies
...
;
L0751:	lda     #<(_playerSpriteData)
	ldx     #>(_playerSpriteData)
	jsr     pushax
	lda     #$03
L07CB:	jsr     _setSpritePalette
;
