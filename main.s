...
;
	...
	.export		_playerSpriteDataFlipped
	.export		_palSprites
	.export		_palBG
...
;
	...
	dey
	sta     (sp),y
	lda     #<(_playerSpriteDataFlipped)
	ldx     #>(_playerSpriteDataFlipped)
;
; } else {
;
	jmp     L02C1
